    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        log.info("Defining Infinispan Global Configuration");
            return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-jhipsterSample-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(io.github.jhipster.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, new JCache<Object, Object>(
                ...
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.jhipster.application.domain.User.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(io.github.jhipster.application.domain.User.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.jhipster.application.domain.Authority.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(io.github.jhipster.application.domain.Authority.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.jhipster.application.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                cacheManager.getCache(io.github.jhipster.application.domain.User.class.getName() + ".authorities").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
